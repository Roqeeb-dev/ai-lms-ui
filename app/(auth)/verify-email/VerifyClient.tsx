...
export default function VerifyClient() {
  ...
  const inputClass =
    "w-full rounded-lg border border-border bg-input px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-input-focus transition-all duration-200 tracking-widest text-center font-mono";
    ...
    <div className="w-full max-w-md flex flex-col gap-6 text-center">
      ...
      <div className="flex flex-col gap-2">
        <button
          ...
          className="w-full rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-semibold text-foreground hover:border-primary hover:text-primary transition-all duration-200 disabled:opacity-60 disabled:pointer-events-none"
        >
